module Bookable
  ...
  def overlaps
    overlapping_bookings = [ 
      karaoke_room.bookings.end_during(start_time, end_time),
      karaoke_room.bookings.start_during(start_time, end_time),
      karaoke_room.bookings.happening_during(start_time, end_time),
      karaoke_room.bookings.enveloping(start_time, end_time),
      karaoke_room.bookings.identical(start_time, end_time)
    ].flatten
